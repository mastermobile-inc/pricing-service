...
def require_site_price_token(x_site_price_token: str | None = Header(default=None)) -> None:
...
def resolve(payload: SiteCustomerPriceRequest) -> SiteCustomerPriceResponse:
