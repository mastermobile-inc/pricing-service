...
def _site_service_request_close_gate_comment(case_id: int) -> str:
    ...
    return (
        ...
        "либо выберите значение в поле «Закрыть без ответа: причина» и закройте "
        "карточку снова. Это выпадающий список в самой карточке: окно «Завершение», "
        "которое показывает Битрикс при переводе стадии, и поле «Результат решения» "
        "гейт не читает. "
