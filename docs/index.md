...
| Logistics/Bitrix24 | `Onepage.LogisticsTelegramMVP.md`, `specs/logistics-control-contour.md`, `TechDesign.LogisticsTelegramMVP.md`, `IntegrationContract.Logistics1C.md`, `IntegrationContract.LogisticsSiteOrders1C.md`, `LogisticsTransportAsIs.md` (фактический процесс транспортной службы), `TZ.LogisticsTransferQR1C.md` (отложенное QR-ТЗ следующего этапа), `specs/transfer-assistant-readonly-v1.md` |
| Expertise/order flow | `Onepage.ExpertiseCaseMVP.md`, `Onepage.SiteServiceRequestsMVP.md`, `specs/site-service-requests-mvp.md` (каноническая Implementation Spec задачи №3223), `TechDesign.ExpertiseCaseMVP.md`, `IntegrationContract.Expertise1C.md`, `IntegrationContract.OrderAssemblyQueue1C.md` (единая CRM-очередь сборки задачи №46), `IntegrationContract.CustomerOrderClosureQueue1C.md` (двухэтапная очередь закрытия заказов УТ 10.3), `Runbook.ExpertiseWave1.md`, `order_flow/README.md`, `specs/site-order-fulfillment-control-contour.md`, `specs/site-defect-archive-search.md` |
